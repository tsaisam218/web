...
if (isset($Confirm)) {   // 確認按鈕
  ...
  if (empty($ErrMsg)) {
    ...
    $sqlcmd = "INSERT INTO namelist (name, phone, address, groupid, birthday, gender, eMail) VALUES ('$Name','$Phone','$Address','$GroupID', '$birthday', '$gender', '$eMail')";    $result = updatedb($sqlcmd, $db_conn);
  ...
  <form action="" method="post" name="inputform">
    ...
    <table border="1" width="60%" cellspacing="0" cellpadding="3" align="center">
      ...
      <tr height="30">
        ...
        <td><input type="text" name="e-mail" value="<?php echo $eMail ?>" size="20"></td>
      </tr>
      <tr height="30">
        <th width="40%">地址</th>
